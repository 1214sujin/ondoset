...
public interface OOTDRepository extends JpaRepository<OOTD, Long> {
	...
	@Query("select new com.ondoset.dto.OOTD.OotdDTO(o.id, (o.departTime/86400+1)*86400-:timezone/1000 date, o.lowestTemp, o.highestTemp, o.imageURL) " +
			"from OOTD o where o.member=:memberId and o.reportedCount<5 and o.isBlinded=false and o.id<:lastPage order by o.id desc limit 10")
	List<OotdDTO> pageMyProfile(@Param("timezone") int timezone, @Param("memberId") Long memberId, @Param("lastPage") int lastPage);
}
